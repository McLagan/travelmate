"""
Comprehensive countries data with flags for TravelMate application
Contains all 195 UN recognized sovereign states with ISO 2-letter codes and Unicode flag emojis
"""

from typing import List, Dict

# Comprehensive list of all countries with ISO 2-letter codes and Unicode flags
...
def get_countries_list() -> List[Dict[str, str]]:
    """
    Get the complete list of countries with flags
    Returns a list of dictionaries with 'code', 'name', and 'flag' keys
    """
    # Convert emoji flags to image URLs
...
def get_country_by_code(country_code: str) -> Dict[str, str] | None:
    """
...
def get_countries_by_name(name_query: str) -> List[Dict[str, str]]:
    """
    Search countries by name (case-insensitive partial match)

    Args:
        name_query: Partial or full country name to search for
    ...
    return [
        ...
        if name_query_lower in country["name"].lower()
    ]